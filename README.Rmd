...
of SNPs within a set accounting for linkage disequilibrium between markers. This
package uses a more efficient method than the original implementation for
computing a set-level p-value, significantly reducing computation time.
...
possible strand flips and reverse reference alleles.
