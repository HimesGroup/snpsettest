...
**g**ene-based **a**ssociation **s**tudy) [1] and it also can be seen as a special
case of SKAT (**s**equence **k**ernel **a**ssociation **t**est) [2] where weights to
the variants are all of the same (i.e., unweighted SKAT). While the VEGAS
software used a simulation-based approach to compute a set-level p-value, it can
...
several methods have been proposed, such as Davies method [3] and Kuonen's
saddlepoint approximations [4]. Compared to a simulation-based approach, these
...
2. Wu, M. C. et al. Rare-Variant Association Testing for Sequencing Data with the
Sequence Kernel Association Test. Am J Hum Genet 89, 82–93 (2011).

3. Davies, R. B. Algorithm AS 155: The Distribution of a Linear Combination of χ2
